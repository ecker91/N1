...
let pessoas = 45, litrosPorPessoa, desperdicioLitros, restoLitros, litrosTotal = 300

desperdicioLitros = Number(prompt('Digite quantos litros foram desperdiçados: '))
restoLitros = Number(prompt('Digite quantos litros sobraram: '))

litrosPorPessoa = (litrosTotal - desperdicioLitros - restoLitros )/pessoas

alert('Foram consumidos em média '+litrosPorPessoa.toFixed(3)+' litros por pessoa')